...
clear
% definition
times = 11200;            % Monte Carlo times(11200)
M = 20:20:120;            % training flame length 
...
%             NMSE_dB_times(sn, t) = calc_NMSE(H_freq_est, H_freq, K, N_r, N_t);
            NMSE_dB_times(tr, t) = calc_NMSE(H_freq_est, H_freq, K, N_r, N_t)-pow2db(N_r*N_t/PL*10^(3));
%             NMSE_dB_times(tr, t) = calc_NMSE(H_freq_est, H_freq, K, N_r, N_t)-mean_PL_factor;
...
%% plot a glaph & save data
% OMP_NMSE = NMSE_dB;
% save("result_OMP_0dB.mat", "sn_dB", "OMP_NMSE", "M", "times");
% figure
