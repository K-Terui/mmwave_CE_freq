...
%             NMSE_dB_times(sn, t) = calc_NMSE(H_freq_est, H_freq, K, N_r, N_t)-pow2db(N_r*N_t/PL*10^(3));
            NMSE_dB_times(sn, t) = calc_NMSE(H_freq_est, H_freq, K, N_r, N_t)-mean_PL_factor;
...
%% save data
% save("result_OMP_M80.mat", "sn_dB", "NMSE_dB");
